...
import com.test.utils.FloatUtils;
...
public class DBManager {
    ...
    public static void initDB(Context context){
        com.test.db.DBOpenHelper helper = new com.test.db.DBOpenHelper(context);  //得到帮助类对象
     ...
     *   kind :表示收入或者支出
     * */
    public static List<com.test.db.TypeBean>getTypeList(int kind){
        List<com.test.db.TypeBean>list = new ArrayList<>();
        //读取typetb表当中的数据
...
//        循环读取游标内容，存储到对象当中
        while (cursor.moveToNext()) {
            ...
            com.test.db.TypeBean typeBean = new com.test.db.TypeBean(id, typename, imageId, sImageId, kind);
            list.add(typeBean);
        }
        return list;
    }
