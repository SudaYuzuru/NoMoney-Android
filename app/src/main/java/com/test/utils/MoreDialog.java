...
import com.test.AboutActivity;
import com.test.AlarmActivity;
import com.test.HistoryActivity;
import com.test.MonthChartActivity;
import com.test.R;
import com.test.SettingActivity;
import com.test.SmallBoxActivity;
...
public class MoreDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        smallboxBtn = findViewById(R.id.dialog_more_btn_smallbox);
        ...
        smallboxBtn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.dialog_more_btn_alarm:
                ...
                getContext().startActivity(intent);
                break;
            case R.id.dialog_more_btn_smallbox:
                intent.setClass(getContext(), SmallBoxActivity.class);
                getContext().startActivity(intent);
                break;
